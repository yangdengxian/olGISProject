...
UIView += "                        <\/li>";
UIView += "                        <li class=\"dropdown\">";
UIView += "                            <a href=\"#\" class=\"dropdown-toggle toolbar mapViewChange\" data-toggle=\"dropdown\" id=\"mapViewChangeBtn\">";
UIView += "                                <span class=\"glyphicon glyphicon-toolbar-mapViewChange\"><\/span>&nbsp; 二三维切换";
UIView += "                                <b class=\"caret\"><\/b>";
UIView += "                            <\/a>";
UIView += "                            <ul class=\"dropdown-menu\">";
UIView += "                                <li>";
UIView += "                                    <a href=\"#\" class=\"toolbar 2dView\" id=\"2dViewBtn\">";
UIView += "                                        <span class=\"glyphicon glyphicon-toolbar-2dView\"><\/span>&nbsp; 二维";
UIView += "                                    <\/a>";
UIView += "                                <\/li>";
UIView += "                                <li>";
UIView += "                                    <a href=\"#\" class=\"toolbar 3dView\" id=\"3dViewBtn\">";
UIView += "                                        <span class=\"glyphicon glyphicon-toolbar-3dView\"><\/span>&nbsp; 三维";
UIView += "                                    <\/a>";
UIView += "                                <\/li>";
UIView += "                            <\/ul>";
UIView += "                        <\/li>";
