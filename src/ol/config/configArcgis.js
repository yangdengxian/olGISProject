    ...
    switch (App) {
        ...
        case 'Chart': //井统计
            mapConfig = {
                ...
                d_mapUrl: [],
                arcgisQueryLayerIds: [],
                mapFullExtent: { "xmin": 72.86, "ymin": 17.73, "xmax": 136.23, "ymax": 53.90, "spatialReference": { "wkid": 4326 } },
                wellId: 0
            };
            break;
        case 'TL': //塔里木
        ...
        case 'demo':
            mapConfig = {
                ...
                d_mapUrl: ["https://sampleserver1.arcgisonline.com/ArcGIS/rest/services/Demographics/ESRI_Census_USA/MapServer"],
                arcgisQueryLayerIds: [0],
                mapFullExtent: { "xmin": -185.337909357176, "ymin": 15.2049923322169, "xmax": -59.5254874993028, "ymax": 74.08248503559, "spatialReference": { "wkid": 4326 } },
                wellId: 0
            };
            break;
